  ...
  return (
    <div className="content-stretch flex flex-col gap-[18px] items-center relative size-full">
      ...
      <div className="content-stretch flex flex-col gap-[11px] items-start relative shrink-0 w-[362px]">
        <div className="backdrop-blur-[8.05px] bg-[rgba(225,234,255,0.8)] h-[56px] relative rounded-[18px] shrink-0 w-full" data-name="Button">
          ...
          <div className="flex flex-row items-center justify-center size-full">
            <div className="content-stretch flex gap-[14px] items-center justify-center px-[18px] relative size-full">

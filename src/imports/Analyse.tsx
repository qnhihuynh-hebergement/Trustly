...
import svgPaths from "./svg-uopclif2jy";
...
export default function Analyse() {
  return (
    <div className="bg-white relative size-full" data-name="analyse">
      ...
      <div className="absolute bg-white bottom-0 content-stretch flex flex-col gap-[26px] items-center justify-center left-0 overflow-clip p-[20px] rounded-tl-[32px] rounded-tr-[32px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] w-[402px]" data-name="Container">
            ...
            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[4px] items-start relative w-full">
              <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                <div className="h-[25px] relative shrink-0 w-[155.297px]" data-name="Heading 2">
                  <p className="absolute font-['Satoshi:Medium',sans-serif] leading-[25px] left-0 not-italic text-[#0f172a] text-[20px] top-[-0.5px] tracking-[-0.4492px] whitespace-nowrap">Analyse terminée</p>
                </div>
              </div>
        ...
        >
          <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative row-1">
            ...
            <div className="col-1 content-stretch flex flex-col gap-[16px] h-[69.333px] items-center justify-center leading-[24px] ml-[57.33px] mt-[45.33px] not-italic py-[7px] relative row-1 text-[#f97316] tracking-[-0.3125px] w-[45.333px] whitespace-nowrap">
              <p className="font-['Satoshi:Bold',sans-serif] relative shrink-0 text-[44px]">50</p>
              <p className="font-['Satoshi:Medium',sans-serif] relative shrink-0 text-[14px]">sur 100</p>
            </div>
          </div>
          ...
          <div className="content-stretch flex flex-col items-start p-[20px] relative w-full">
            <div className="content-stretch flex flex-col gap-[14px] items-start relative shrink-0 w-full" data-name="Container">
              <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full">
                ...
                <p className="font-['Satoshi:Medium',sans-serif] leading-[27px] not-italic relative shrink-0 text-[#0f172a] text-[18px] tracking-[-0.4395px] whitespace-nowrap">Fiabilité modérée</p>
              </div>

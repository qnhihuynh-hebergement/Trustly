...
import svgPaths from "./svg-eyssw771kv";
...
function Home1NavIconLabel({ children }: React.PropsWithChildren<{}>) {
  return (
...
function Frame9SidebarIconLabel({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="relative shrink-0 w-[45px]">
      <div className="flex flex-col items-center size-full">
...
function TopSectionBookmarkSearch() {
  return (
...
function LiveText({ text }: LiveTextProps) {
  return (
...
function Notification({ additionalClassNames = "" }: NotificationProps) {
  return (
    ...
    <div className={className || `relative ${isNotState ? "h-[31px]" : ""}`}>
      <div className="flex flex-col items-center size-full">
        <div className={`content-stretch flex flex-col gap-[5px] items-center relative ${isNotState ? "h-full" : ""}`}>
          ...
          {isState && notification && <Notification additionalClassNames="right-[-4px]" />}
          {isState && live && <LiveText text="LIVE" />}
          ...
          {isNotState && notification && <Notification additionalClassNames="right-[-3.5px]" />}
          {isNotState && live && <LiveText text="LIVE" />}
        </div>
      </div>
    </div>
  );
        ...
        <div className={`relative ${isFriends ? "content-stretch flex items-center justify-between px-[14px] size-full" : "h-full shrink-0"}`}>
          ...
          {isFriends && (
            <>
              ...
              <TopSectionBookmarkSearch />
            </>
          )}
        </div>
        {isHome && <TopSectionBookmarkSearch />}
      </div>
    </div>
  );
}
...
export default function Home1() {
  return (
    <div className="bg-black relative size-full" data-name="Home">
              ...
              <Frame9SidebarIconLabel>
                <div className="relative shadow-[1px_1px_1px_0px_rgba(0,0,0,0.25)] shrink-0 size-[30px]" data-name="Bookmark">
                  <div className="absolute inset-[6.67%_6.39%_9.41%_6.67%]" data-name="Union">
                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26.0832 25.1753">
                      <path d={svgPaths.p3651a900} fill="var(--fill-0, white)" id="Union" />
                    </svg>
                  </div>
                </div>
      ...
      <TopSection className="absolute cursor-pointer h-[36px] left-0 top-[56px] w-[393px]" />

...
export default function Frame() {
  return (
    <div className="bg-gradient-to-b content-stretch flex from-[rgba(37,99,235,0.1)] items-start justify-between p-[16px] relative rounded-[23px] size-full to-[rgba(37,99,235,0.01)]">
      ...
      <div className="absolute h-[132px] left-[204px] top-[-23px] w-[142px]" data-name="Group 6 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgGroup61} />
      </div>
      <Frame2 />
